...
public class Response {
    ...
    @JsonIgnore
    public Response(String status, String data, String origin, String destination) {
        this.status = status;
        this.data = data;
        this.origin = origin;
    ...
    public String getJsonString(){
        ...
        try {
            ...
            OuiLogger.log(Level.ERROR, "Could not convert response object to a json string: " +this.origin);
    ...
    public String toString(){
        return dateTime + " " + status + " --- " + "| " + origin + " -> " + destination + " | "
                + "Data: " +data.toString();
    }
